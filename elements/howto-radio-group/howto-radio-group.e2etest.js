...
describe('howto-radio-group', function() {
  ...
  it('should handle arrow keys',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:nth-of-type(1)');
        window.expectedSecondRadio =
          document.querySelector('[role=radio]:nth-of-type(2)');
      });
  ...
  it('should wrap focus',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:first-of-type');
        window.expectedLastRadio =
          document.querySelector('[role=radio]:last-of-type');
      });
  ...
  it('should focus the last radio on [end]',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:first-of-type');
  ...
  it('should focus the first radio on [home]',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:first-of-type');
  ...
  it('should mark the selected element as aria-checked=true',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:nth-of-type(1)');
  ...
  it('should return focus to the checked element',
    async function() {
      await this.driver.executeScript(_ => {
        window.expectedFirstRadio =
          document.querySelector('[role=radio]:nth-of-type(1)');
